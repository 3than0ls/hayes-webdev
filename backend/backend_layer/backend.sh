...
[ -x ./backend_layer/checksum ] || which checksum 2>/dev/null || die "expecting checksum executable to exist or be in PATH"
# [ -f ./backend_layer/checksum.c ] || die "expecting checksum.c source file in the current directory"
PATH="$PATH:."
export PATH
